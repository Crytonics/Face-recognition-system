...
def opencv_GrayCameraNoRectanglesLabels(test1, test2):
      global gray_img, gray_img2
      gray_img = test1
      gray_img2 = test2

def Gray_Camera_No_Rectangles_Labels(stop_thread, MainWindow_btn, Data_btn, Settings_btn, Right_frame, Main_frame, root): 
    ...
    from Data import clear_buttons_cam_GRAY_NO
    clear_buttons_cam_GRAY_NO(Camera_next_btn, Camera_prev_btn, Camera_all_btn)

    from Settings import clear_buttons_cam_GRAY_NO_Settings
    clear_buttons_cam_GRAY_NO_Settings(Camera_next_btn, Camera_prev_btn, Camera_all_btn)
