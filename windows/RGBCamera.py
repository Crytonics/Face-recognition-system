...
def all_cameras():
        ...
        def update_frame():
                        ...
                        if confidence < 85:
                                ...
                                if len(faces_detected_frontalface) > 0:
                                        for (x, y, w, h) in faces_detected_frontalface:
                                                ...
                                                put_text(test_img, "Nepoznato lice", x, y)
                ...
                for face2 in global_faces_detected_frontalface2:
                        ...
                        draw_rect2(test_img2, face2)
                        predict_name2 = lables2[label2]

                        if confidence2 < 85:
                                put_text2(test_img2, predict_name2, x, y)
                                ...
                                if len(global_faces_detected_frontalface2) > 0:
                                        for (x, y, w, h) in global_faces_detected_frontalface2:
                                                ...
                                                put_text(test_img2, "Nepoznato lice", x, y)
...
def opencv_RGBCamera(test1, test2, test3, test4, test5, test6, test7):
      global faces_detected_frontalface, gray_img, test_img, face_recognizer_frontalface, global_faces_detected_frontalface2, gray_img2, test_img2
...
def RGB_Camera(stop_thread, MainWindow_btn, Data_btn, Settings_btn, Right_frame, Main_frame, root): 
    ...
    from Data import clear_buttons_cam_RGBCamera
    clear_buttons_cam_RGBCamera(Camera_next_btn, Camera_prev_btn, Camera_all_btn)

    from Settings import clear_buttons_cam_RGBCamera_Settings
    clear_buttons_cam_RGBCamera_Settings(Camera_next_btn, Camera_prev_btn, Camera_all_btn)
